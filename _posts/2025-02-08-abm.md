...
stateDiagram-v2
direction LR
   sensitive cells --> resistent cells: 0.1
   resistent cells --> dead cells: 0.3
   sensitive cells --> dead cells: 0.6
   sensitive cells --> sensitive cells: 0.3
   resistent cells --> resistent cells: 0.7
   dead cells --> dead cells: 1
```
